...
if ($(".txtCell_input").length !=0) { $(".txtCell_input").css("background-color","#B9E916"); $(".txtCell_input").css("color",colorText);};
if ($(".txtCell_txt").length !=0) { $(".txtCell_txt").css("background-color","#B9E916")}
if ($(".txtCell_txt").length !=0) {var color2="#A426D9";var color1="#B9E916";
