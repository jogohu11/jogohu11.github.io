...
var timeOnMessage=5; messageOk="Lo lograste"; messageTime="Llegaste al limite del tiempo"; messageError=""; messageErrorG=""; messageAttempts="Lo siento se termino el limite de intentos"; isShowMessage=false;
...
var wo2=["DEIDARA","LEE","GAARA","ITACHI","KAKASHI","SASUKE","SHINO","MINATO"];im2=["","","","","","","",""];mp32=["","","","","","","",""];alt2=["","","","","","","",""];
var cols=4; rows=4; items=8; itp=["MTA=","MTE=","MTI=","MTM=","MTQ=","MTU=","MTY=","MTc="]; pos=["MjA=","Mjc=","MjM=","MjI=","MjQ=","MjU=","MjY=","MjE="];
