...
var timeOnMessage=2; messageOk="Lo lograste"; messageTime="Se acabo el tiempo"; messageError="Error"; messageErrorG="Error"; messageAttempts="Lo siento se acabo el numero de intentos"; isShowMessage=false;
...
var cR=["<p>México</p>","<p>India</p>","<p>China</p>","<p>Italia</p>","<p>Perú</p>","<p>Jordania</p>","<p>Brasil</p>"]; ansRL=["Mg==","NQ==","Mw==","MA==","NA==","Ng==","MQ=="];
var iR=["<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/mexico.jpg'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/india.jpg'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/china.jpg'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/italia.jpg'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/Per__.png'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/jordania.jpg'></div>","<div  align='center'><img alt='' src='Relacionar_Frases_Im__genes_resources/media/brasil.jpg'></div>"];
var auR=[4,7,1,3,5,2,6];
