...
contexto.fillRect(0, 0, canvas.width, canvas.height);contexto.font = "24px " + fMenssage;
var metricsW = contexto.measureText(textBNext).width;var x = canvas.width - metricsW -50 ;var y = canvas.height-24-40;
...
roundedRect(contexto, x, y, metricsW+45,24+20, 5, colorButton);contexto.shadowColor = "black";contexto.shadowBlur = 15;
...
contexto.fillText(textBNext,x+10,y+24+10);contexto.lineWidth=5;contexto.stroke();contexto.fill();
